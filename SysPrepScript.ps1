...
#REG ADD "HKLM\SOFTWARE\Policies\Microsoft\OneDrive" /v "KFMSilentOptIn" /t REG_SZ /d "bad69d79-XXXX-4e94-9157-966cbd2d9933" /f
...
New-ItemProperty -Path HKLM:\Software\FSLogix\Profiles -Name "VHDLocations" -Value \\mswvd-dc1\WVDFSPROF -PropertyType MultiString -Force
